...
LATEST_FITNESS_FEATURIZER_PATH = os.path.abspath(os.path.join(_FILE_DIR, '../models/fitness_featurizer_2023_11_15.pkl.gz'))
LATEST_FITNESS_FUNCTION_DATE_ID = 'cv_fitness_model_in_data_prop_L2_categories_minimal_counting_grammar_use_forall_seed_42_2023_11_16'
