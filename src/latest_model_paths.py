...
LATEST_FITNESS_FEATURIZER_PATH = os.path.abspath(os.path.join(_FILE_DIR, '../models/fitness_featurizer_2023_09_10.pkl.gz'))
LATEST_FITNESS_FUNCTION_DATE_ID = 'full_features_no_in_data_all_L1_2023_09_11'
