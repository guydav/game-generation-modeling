...
LATEST_AST_N_GRAM_MODEL_PATH = os.path.abspath(os.path.join(_FILE_DIR, '../models/ast_5_ngram_model_2023_08_29.pkl'))
LATEST_FITNESS_FEATURIZER_PATH = os.path.abspath(os.path.join(_FILE_DIR, '../models/fitness_featurizer_2023_08_28.pkl.gz'))
LATEST_FITNESS_FUNCTION_DATE_ID = 'full_features_no_in_data_all_L1_2023_08_28'
