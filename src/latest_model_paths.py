...
LATEST_AST_N_GRAM_MODEL_PATH = os.path.abspath(os.path.join(_FILE_DIR, '../models/ast_5_ngram_model_2023_11_01.pkl'))
LATEST_FITNESS_FEATURIZER_PATH = os.path.abspath(os.path.join(_FILE_DIR, '../models/fitness_featurizer_2023_10_27.pkl.gz'))
LATEST_FITNESS_FUNCTION_DATE_ID = 'cv_fitness_model_in_data_prop_L2_categories_minimal_counting_grammar_use_forall_seed_42_2023_10_27'
...
MAP_ELITES_MODELS = {
    ...
    'objects_and_predicates': MapElitesModelSpec(
        'map_elites_minimal_counting_grammar_use_forall_L2_latest_setup_uniform_seed_42_gen_2048_2023_10_30',
    ...
    'object_and_predicates_with_expected_values_bc': MapElitesModelSpec(
        'map_elites_minimal_counting_grammar_use_forall_L2_latest_setup_expected_values_uniform_seed_42_gen_2048_2023_10_30',
        'Using New "Goodness" BC | Uniform archive sampling | L2 regularization'
    ),
    'exemplar_preferences_by_bcs': MapElitesModelSpec(
        'map_elites_minimal_counting_grammar_use_forall_L2_exemplar_preferences_bc_setup_uniform_seed_42_gen_2048_2023_11_01',
    ...
    'exemplar_preferences_by_bcs_with_expected_values_bc': MapElitesModelSpec(
        'map_elites_minimal_counting_grammar_use_forall_L2_exemplar_preferences_bc_expected_values_uniform_seed_42_gen_2048_2023_10_31',
